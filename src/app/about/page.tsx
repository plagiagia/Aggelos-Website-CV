...
const cvData = {
  ...
  academicProjects: [
    {
      title: { en: "Master's Thesis — Distinction", de: 'Masterarbeit — Auszeichnung' },
      description: {
      ...
      <section className="container border-t border-border/40 pt-32">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-4 reveal">
            <div className="flex flex-col md:flex-row lg:flex-col items-start md:items-center lg:items-start gap-4 mb-12">
              <h2 className="text-3xl md:text-4xl font-serif italic px-2 border-l-2 border-accent/20">
                {t('about.cvTitle', language)}
              </h2>
              <a
                href="/cv/Aggelos-Giannoulis-CV.pdf"
                download
                className="text-xs uppercase tracking-[0.2em] border border-border/40 px-4 py-2 hover:border-accent hover:bg-accent/10 transition-all inline-flex items-center gap-2"
              ...
              >
                ...
                >
                  <path
                    d="M6 1V8M6 8L2 4M6 8L10 4M1 9V10C1 10.5523 1.44772 11 2 11H10C10.5523 11 11 10.5523 11 10V9"
                    stroke="currentColor"
                    strokeWidth="1.5"
                    strokeLinecap="round"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 reveal del-2">
              ...
              <div className="flex flex-col justify-center items-center text-center p-8 bg-card/30 border border-border/40 reveal del-3">
                <p className="text-xs uppercase tracking-[0.3em] mb-4 opacity-40">
                  {language === 'de' ? 'VERFÜGBAR FÜR' : 'Available For'}
                </p>
